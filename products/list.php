...
<body style="background-color: #eee;">
    ...
    <body>
        ...
        <div class="container">
            ...
            <p class="alert-danger"><?= isset($_SESSION['erorr']) ? ($_SESSION['erorr']) : "" ?></p>
                ...
                <tbody>
                    ...
                    ?>
                        <tr class="table-light">
                            ...
                            <td><?= $product->name; ?></td>
                            <td><?= $product->price; ?></td>
                            <td><img style="width:100px; height:100px;" src="../images/<?= $product->image ?>" alt="Item 2"></td>

                            <td>
                                <a href="edit.php?id=<?= $product->id ?>" class="btn btn-warning"><i class="fas fa-edit"></i></a>
                                <a href="delete.php?id=<?= $product->id ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this item?');"><i class="far fa-trash-alt"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
